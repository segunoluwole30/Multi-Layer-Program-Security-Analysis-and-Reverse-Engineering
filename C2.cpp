...
std::string system_call(int arg) {
    ...
    if (arg == 0) { //shutdown -P
        ...
        start = (rand() % rand() % rand() % rand()) / (rand() % 6666666) + 90;
